...
class Toolbox extends EventEmitter {
  ...
  #nodePicker;
  #notificationBox;
  #onBooleanConfigurationPrefChangeHandler
  #onBlur;
  ...
  #onResourceUpdated;
  #onTabsOrderUpdated;
  #onTargetAvailableHandler;
  #onTargetDestroyedHandler;
  #onTargetSelectedHandler;
  ...
  #refreshHostTitle;
  #resolveIsOpen;
  #saveSplitConsoleHeightHandler;
  #sourceMapLoader;
  #sourceMapURLService;
  #splitConsole;
  #splitConsoleEnabled;
  #splitConsoleOnKeypressHandler;
  #store;
  #tabBar;
  ...
  constructor({
    ...
    this.#toolRegistered = this.#toolRegistered.bind(this);
    this.#toolUnregistered = this.#toolUnregistered.bind(this);
    this.#refreshHostTitle = this.#refreshHostTitle.bind(this);
    ...
    this.#splitConsoleOnKeypressHandler = this.#splitConsoleOnKeypress.bind(this);
    this.closeToolbox = this.closeToolbox.bind(this);
    this.destroy = this.destroy.bind(this);
    this.#saveSplitConsoleHeightHandler = this.#saveSplitConsoleHeight.bind(this);
    this.#onFocus = this.#onFocus.bind(this);
    this.#onBlur = this.#onBlur.bind(this);
    this.#onBrowserMessageHandler = this.#onBrowserMessage.bind(this);
    this.#onTabsOrderUpdated = this.#onTabsOrderUpdated.bind(this);
    this.#onToolbarFocus = this.#onToolbarFocus.bind(this);
    this.#onToolbarArrowKeypress = this.#onToolbarArrowKeypress.bind(this);
    this.#onPickerClick = this.#onPickerClick.bind(this);
    this.#onPickerKeypress = this.#onPickerKeypress.bind(this);
    this.#onPickerStarting = this.#onPickerStarting.bind(this);
    ...
    this.#onPickerPreviewed = this.#onPickerPreviewed.bind(this);
    this.#onInspectObject = this.#onInspectObject.bind(this);
    this.#onNewSelectedNodeFront = this.#onNewSelectedNodeFront.bind(this);
    this.#onToolSelected = this.#onToolSelected.bind(this);
    ...
    this.#pingTelemetrySelectTool = this.#pingTelemetrySelectTool.bind(this);
    this.toggleSplitConsole = this.toggleSplitConsole.bind(this);
    this.toggleOptions = this.toggleOptions.bind(this);
    this.#onTargetAvailableHandler = this.#onTargetAvailable.bind(this);
    this.#onTargetDestroyedHandler = this.#onTargetDestroyed.bind(this);
    this.#onTargetSelectedHandler = this.#onTargetSelected.bind(this);
    this.#onResourceAvailable = this.#onResourceAvailable.bind(this);
    this.#onResourceUpdated = this.#onResourceUpdated.bind(this);
    this.#onToolSelectedStopPicker = this.#onToolSelectedStopPicker.bind(this);
  ...
  async open() {
    try {
      ...
      this.commands.targetCommand.on(
        ...
        this.#onTargetThreadFrontResumeWrongOrder.bind(this)
      );
      registerStoreObserver(
        this.commands.targetCommand.store,
        this.#onTargetCommandStateChange.bind(this)
      );
      ...
      await this.commands.targetCommand.watchTargets({
        ...
        onAvailable: this.#onTargetAvailableHandler,
        onSelected: this.#onTargetSelectedHandler,
        onDestroyed: this.#onTargetDestroyedHandler,
      });
      ...
      this.doc
        ...
        .addEventListener("command", this.#saveSplitConsoleHeightHandler);
  ...
  #addChromeEventHandlerEvents() {
    ...
    this.#chromeEventHandler.addEventListener("keydown", this.#onKeydownHandler);
    this.#chromeEventHandler.addEventListener(
      "keypress",
      this.#splitConsoleOnKeypressHandler
    );
    ...
    this.#chromeEventHandler.addEventListener("mousedown", this.#onMouseDownHandler);
  }
  ...
  #removeChromeEventHandlerEvents() {
    ...
    this.#chromeEventHandler.removeEventListener("keydown", this.#onKeydownHandler);
  ...
  #addWindowListeners() {
    ...
    this.win.addEventListener("message", this.#onBrowserMessageHandler, true);
  }
  ...
  #removeWindowListeners() {
    ...
    if (this.win) {
      ...
      this.win.removeEventListener("message", this.#onBrowserMessageHandler, true);
    }
  }
  ...
  async #listenAndApplyConfigurationPref() {
    this.#onBooleanConfigurationPrefChangeHandler =
      this.#onBooleanConfigurationPrefChange.bind(this);
   ...
   */
  async #onBooleanConfigurationPrefChange(subject, topic, prefName) {
    const { name, thread } = BOOLEAN_CONFIGURATION_PREFS[prefName];
    const value = Services.prefs.getBoolPref(prefName, false);
  ...
  getHighlighter() {
     ...
     */
    const getInspector = async options => {
      const inspector = this.getPanel("inspector");
      if (inspector) {
        return inspector;
      }
     ...
     */
    async function waitForHighlighterEvent(eventName) {
    ...
    return {
      ...
      waitForHighlighterShown: this.#safeAsyncAfterDestroy(async () => {
        return waitForHighlighterEvent("highlighter-shown");
      }),

      waitForHighlighterHidden: this.#safeAsyncAfterDestroy(async () => {
        return waitForHighlighterEvent("highlighter-hidden");
      }),
    };
  }
  ...
  async #destroyToolbox() {
    ...
    if (this.webconsolePanel) {
      ...
      this.webconsolePanel.removeEventListener(
        "resize",
        this.#saveSplitConsoleHeightHandler
      );
    ...
    // We need to grab a reference to win before this.#host is destroyed.
    const win = this.win;
      ...
      resolve(
        onResetPreference
          ...
          .then(() => {
            ...
            // Free #host after the call to destroyed in order to let a chance
